...
pub struct Application {
    name: &'static str,
    systems: Systems,
    services: HashMap<std::any::TypeId, Box<dyn std::any::Any>>,
}
...
impl Application {
    ...
    {
        self.services.get_mut(&TypeId::of::<T>()).unwrap().downcast_mut::<T>().unwrap()
    }
...
async fn run(event_loop: EventLoop<()>, window: Window, app: &mut Application) {
