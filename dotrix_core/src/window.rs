...
const PLATFORM_ERROR: &str = "Not supported on this platform.";
...
impl Window {
    ...
    pub fn set_cursor_grab(&mut self, grab: bool) {
        self.window.set_cursor_grab(grab).expect(PLATFORM_ERROR);
